...
Two self-contained HTML reports generated by the smoke test pipeline on
synthetic data are committed to [`examples/`](examples/) so you can see what
Lymphix produces before running it yourself.

| Example | View live (htmlpreview) | Raw file |
|---|---|---|
| **Clonal sample** — dominant IGH + TRB clones, expected verdict "Bi-clonal" | [open in browser](https://htmlpreview.github.io/?https://github.com/Trethewey/lymphix/blob/main/examples/clonal_sample_report.html) | [examples/clonal_sample_report.html](examples/clonal_sample_report.html) |
| **Polyclonal sample** — diverse repertoire, expected verdict "Polyclonal" | [open in browser](https://htmlpreview.github.io/?https://github.com/Trethewey/lymphix/blob/main/examples/polyclonal_sample_report.html) | [examples/polyclonal_sample_report.html](examples/polyclonal_sample_report.html) |
