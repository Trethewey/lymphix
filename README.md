...
Two reports generated by the smoke-test pipeline on synthetic data, committed
to [`examples/`](examples/). Click either PNG to open at full size, or use the
htmlpreview links underneath to view the **fully-interactive Plotly HTML**.

<table>
<tr>
  <td align="center" width="50%">
    <a href="examples/clonal_sample_report.png">
      <img src="examples/clonal_sample_report.png" alt="Clonal sample report" width="100%"/>
    </a>
    <br/><b>Clonal sample</b> — dominant IGH + TRB clones<br/>
    Verdict: <i>"Bi-clonal — B-cell (IGH) and T-cell (TRB)"</i><br/>
    <a href="https://htmlpreview.github.io/?https://github.com/Trethewey/lymphix/blob/main/examples/clonal_sample_report.html">▶ live interactive HTML</a>
    &nbsp;·&nbsp;
    <a href="examples/clonal_sample_report.html">raw .html</a>
  </td>
  <td align="center" width="50%">
    <a href="examples/polyclonal_sample_report.png">
      <img src="examples/polyclonal_sample_report.png" alt="Polyclonal sample report" width="100%"/>
    </a>
    <br/><b>Polyclonal sample</b> — diverse repertoire<br/>
    Verdict: <i>"Polyclonal repertoire — no dominant clone detected"</i><br/>
    <a href="https://htmlpreview.github.io/?https://github.com/Trethewey/lymphix/blob/main/examples/polyclonal_sample_report.html">▶ live interactive HTML</a>
    &nbsp;·&nbsp;
    <a href="examples/polyclonal_sample_report.html">raw .html</a>
  </td>
</tr>
</table>
